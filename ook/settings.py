...
DATABASES = {
	# databases are defined in development/production
}
...
SECRET_KEY = '*4-^1%@#dgc%8_hi6m055zvr2nr#4_0=3h49964lrbug899g5='
...
MIDDLEWARE_CLASSES = (
    ...
    'ook.middleware.SessionVariablesMiddleware',
)

ROOT_URLCONF = 'ook.urls'
